...
from torchvision.datasets import ImageFolder, Imagenette, ImageNet, CIFAR10, CIFAR100
import glob
...
def create_imagenet_dataloader(root_path: str, batch_size: int = 64, transform=None, shuffle: bool = False):
    """
    Creates a DataLoader for the Imagenette dataset with appropriate transformations.
